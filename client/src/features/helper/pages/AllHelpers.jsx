    ...
    const fetchCars = async () => {
      try {
        const res = await axios.get(
          'http://localhost:8080/api/helper/all-helpers'
        );

        console.log(res.data.helpers);
        const data = res.data.helpers;
        setHelpers(data);
        console.log('cars', helpers);
      } catch (error) {
            ...
            helpers.map((helper) => (
              ...
              >
                ...
                <div className="grid gap-1 p-4">
                  ...
                  <div className="text-2xl font-semibold">{helper.number} $ / Hour</div>
