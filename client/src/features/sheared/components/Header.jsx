      ...
      <header className=" bg-[#173A6C] text-white flex items-center h-16 px-4 border-b  w-full shrink-0 dark:bg-gray-950 md:px-6">
        <nav className="hidden w-full max-w-7xl grid-cols-4 items-center gap-4 justify-between md:grid md:gap-8 lg:gap-12">
          ...
          <div className="ml-auto flex items-center space-x-4">
            ...
            <a
              className="rounded-full border inline-flex items-center justify-center translate-y-0.5 border-gray-200 h-8 w-8 border-gray-200 border-gray-200 hover:border-gray-300 hover:text-gray-50 focus:border-gray-300 dark:border-gray-800 dark:hover:border-gray-950 dark:hover:text-gray-950 dark:focus:border-gray-950"
              href="#"
            >
