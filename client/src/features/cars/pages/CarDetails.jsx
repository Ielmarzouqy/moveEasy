      ...
      <div className="w-[400px]">
        ...
        >
          ...
          <form className="p-6 space-y-4">
            ...
            <button type="submit" className="inline-flex justify-center w-full rounded-md border border-6 bg-[#173A6C] py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-offset-2">
              Rant Now
            </button>
          </form>
        </div>
